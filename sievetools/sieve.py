# Importing the packages that our functions use
import math
import numpy as np
"""
Defined the two implementations of functions to determine all prime numbers below nmax
Inputs: nmax

Function 1: eratosthenes_1
Function 2: eratosthenes_2
"""

# Defining function for eratosthenes_1
def eratosthenes_1(nmax):
    all_primes = []
...
# Defining functions for eratosthenes_2

def eratosthenes_2(nmax):
    all_primes = []
